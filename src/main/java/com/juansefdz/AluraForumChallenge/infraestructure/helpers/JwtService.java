package com.juansefdz.AluraForumChallenge.infraestructure.helpers;
...
public class JwtService {
    ...
    // Build JWT
    public String getToken(Map<String, Object> claims, AccountEntity account) {
        return Jwts.builder()
    ...
    public String getToken(AccountEntity account) {
        ...
        claims.put("idAccount", account.getId());
